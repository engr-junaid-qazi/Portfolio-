    ...
    return (
        <div>
            ...
            <footer className="text-black-600 body-font">
                <div className="pt-2 pb-2 pl-0 bg-blue-300 container px-5 py-5 mx-auto flex items-center sm:flex-row flex-col rounded-t">
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a title='Facebook' href='https://web.facebook.com/profile.php?id=100011665863653' target='_blank' className="hover:text-red-600 hover:text-xl text-lg text-black-800 cursor-pointer">
                            <BsFacebook />
                        </a>
